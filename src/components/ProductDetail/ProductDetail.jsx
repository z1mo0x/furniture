...
export default function ProductDetail({ image, title, price, description, rating }) {
    ...
    const HalfStar = () => (
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="gold" class="bi bi-star-half" viewBox="0 0 16 16">
            ...
            <div className="container">
                <div className={styles.detail__wrapper}>
                    ...
                    <div className={styles.detail__info}>
                        ...
                        <div className={styles.detail__descr}>{description} <HalfStar /></div>
                    </div>
